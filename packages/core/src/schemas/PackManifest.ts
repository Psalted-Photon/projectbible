...
export interface PackEntry {
  ...
  /** Pack type */
  type: 'translation' | 'lexicon' | 'dictionary' | 'study' | 'audio' | 'bootstrap' | 'references' | 'geonames' | 'headings' | 'people' | 'isbe' | 'art';
...
export function validatePackEntry(pack: any): pack is PackEntry {
  ...
  // Validate type
  const validTypes = ['translation', 'lexicon', 'dictionary', 'study', 'audio', 'bootstrap', 'headings', 'geonames', 'people', 'isbe', 'art'];
