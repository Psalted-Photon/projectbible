...
export interface PackEntry {
  ...
  /** Pack type */
  type: 'translation' | 'lexicon' | 'dictionary' | 'study' | 'audio' | 'bootstrap' | 'references' | 'geonames' | 'headings' | 'people' | 'isbe' | 'encyclotopical' | 'art';
...
export function validatePackEntry(pack: any): pack is PackEntry {
  ...
  // Validate type
  const validTypes = ['translation', 'lexicon', 'dictionary', 'study', 'audio', 'bootstrap', 'references', 'headings', 'geonames', 'people', 'isbe', 'encyclotopical', 'art'];
