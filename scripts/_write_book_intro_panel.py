"""Temporary helper: writes the updated BookIntroPanel.svelte"""
import pathlib

OUT = pathlib.Path("apps/pwa-polished/src/components/BookIntroPanel.svelte")
...
<div class="book-intro-panel" class:open>
  ...
  <div class="intro-header">
    ...
    <div class="intro-title">
      ...
      {:else}
        <span class="intro-icon">\U0001f4d6</span>
...
print(f"Written {OUT.stat().st_size} bytes OK")
